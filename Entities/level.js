class Levels {
    ...
    loadPlatforms() {
        ...
        if (this.id == 1) {
            ...
            this.platforms[6] = new Platform(1200, 400, 300, 10, "blue", false, false, 0, false, 0);
            //! when the height is below like 200(top of screen), it should generally be more difficult but have more coins
            this.platforms[7] = new Platform(1100, 500, 150, 10, "blue", false, false, 0, false, 0);
            this.platforms[8] = new Platform(1150, 150, 150, 10, "blue", true, true, 0, false, 0);
            this.platforms[9] = new Platform(1700, 150, 200, 10, "blue", false, true, 0, true, 0);
            this.platforms[10] = new Platform(1650, 450, 150, 10, "blue", false, false, 0, true, 0);
            this.platforms[11] = new Platform(1700, 275, 150, 10, "blue", false, true, 0, false, 0);
            this.platforms[12] = new Platform(1900, 325, 150, 10, "blue", false, true, 0, false, 1);
            this.platforms[13] = new Platform(2100, 350, 150, 10, "blue", false, true, 0, false, 0);
            ...
            this.platforms[16] = new Platform(3000, 325, 150, 10, "blue", false, true, 0, false, 0);
