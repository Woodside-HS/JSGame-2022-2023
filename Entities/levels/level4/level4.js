class level4 extends Level {
    ...
    loadEnemies() {
        this.enemies[0] = new Ghost2(150, 500, 300, 50, 20)
        this.enemies[1] = new Ghost2(650, 500, 300, 50, 20)
        this.enemies[2] = new Ghost2(1050, 500, 300, 50, 20)
        this.enemies[3] = new Clown(150, 670, 300, 50, 20)
        this.enemies[4] = new Ghost2(2050, 250, 300, 50, 20)
        this.enemies[5] = new Ghost2(2150, 150, 300, 50, 20)
        this.enemies[6] = new Ghost2(2250, 250, 300, 50, 20)
        this.enemies[7] = new Ghost2(2350, 150, 300, 50, 20)
        this.enemies[8] = new Ghost2(2450, 250, 300, 50, 20)
        this.enemies[9] = new Ghost2(2550, 150, 300, 50, 20)
        this.enemies[10] = new Ghost2(2650, 250, 300, 50, 20)
        this.enemies[11] = new Ghost2(2750, 150, 300, 50, 20)
        this.enemies[12] = new Ghost2(2850, 250, 300, 50, 20)
        this.enemies[13] = new Ghost2(2950, 150, 300, 50, 20)
        ...
        this.enemies[26] = new Ghost2(5100, 100, 300, 50, 20)
        this.enemies[27] = new Ghost2(5200, 100, 300, 50, 20)
        this.enemies[28] = new Ghost2(5300, 100, 300, 50, 20)
        this.enemies[29] = new Ghost2(5400, 100, 300, 50, 20)
        this.enemies[30] = new Ghost2(5500, 100, 300, 50, 20)
        this.enemies[31] = new Clown(5500, 200, 100, 50, 20)
        this.enemies[32] = new Ghost2(6050, 200, 100, 50, 20)
        this.enemies[33] = new Ghost2(6350, 300, 100, 50, 20)
        this.enemies[34] = new Ghost2(6650, 250, 100, 50, 20)
        this.enemies[35] = new Ghost2(6950, 200, 100, 50, 20)
    }
