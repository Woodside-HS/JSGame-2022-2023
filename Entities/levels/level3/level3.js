class level3 extends Level{
    constructor(id, levels){
        ...
        this.loadCoins();
        this.loadResources([6],[4],[5]);
        this.loadEnemies([11], [3, 3]);
        this.endX;
        this.endY;
    }
    ...
    loadPlatforms() {
        ...
        this.platforms[4] = new Level3Platform(770,300,100, false);
        this.platforms[5] = new Level3Platform(950,325,50, false); 
        ...
        this.platforms[12] = new Level3Platform(1840,400,50, false);
        this.platforms[13] = new Level3Platform(1970,400,100, false);
        // this.platforms[14] = new Level3Platform(1430,370,20, true);
        // this.platforms[15] = new Level3Platform(1520,380,20, true);
        // this.platforms[16] = new Level3Platform(1610,390,20, true);
        // this.platforms[17] = new Level3Platform(1700,350,100, false);
        // this.platforms[18] = new Level3Platform(1840,400,50, false);
        // this.platforms[19] = new Level3Platform(1970,400,100, false);
        // this.platforms[20] = new Level3Platform(1430,370,20, true);
        // this.platforms[21] = new Level3Platform(1520,380,20, true);
        // this.platforms[22] = new Level3Platform(1610,390,20, true);
        // this.platforms[23] = new Level3Platform(1700,350,100, false);
        // this.platforms[24] = new Level3Platform(1840,400,50, false);
        // this.platforms[25] = new Level3Platform(1970,400,100, false);
        // this.platforms[26] = new Level3Platform(1430,370,20, true);
        // this.platforms[27] = new Level3Platform(1520,380,20, true);
        // this.platforms[28] = new Level3Platform(1610,390,20, true);
        // this.platforms[29] = new Level3Platform(1700,350,100, false);
        // this.platforms[30] = new Level3Platform(1840,400,50, false);
